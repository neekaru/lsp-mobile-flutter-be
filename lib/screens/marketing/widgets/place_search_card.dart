    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          ...
          width: isSelected ? 2.0 : (isSaved ? 1.5 : 1.0),
        ),
        boxShadow: [
          BoxShadow(
            color: isSelected
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Top Row: Category tag + Rating + Map Focus / External Directions icon
                Row(
                  children: [
                    // Category Chip
                    Container(
                      ...
                      ClipRRect(
                        ...
                        child: Image.network(
                          ...
                          errorBuilder: (context, error, stackTrace) =>
                            ...
                            child: Icon(
                                _getCategoryIcon(place.inferredCategory),
                                color: themeColor,
                                size: 28),
                          ),
                        ),
