...
class SertifikatStatistikScreen extends StatefulWidget {
  final VoidCallback? onBackToHome;
  final ValueChanged<String>? onSwitchView;
  
  const SertifikatStatistikScreen({super.key, this.onBackToHome, this.onSwitchView});

  @override
  State<SertifikatStatistikScreen> createState() => _SertifikatStatistikScreenState();
}

class _SertifikatStatistikScreenState extends State<SertifikatStatistikScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: widget.onBackToHome == null && widget.onSwitchView == null,
      onPopInvokedWithResult: (bool didPop, dynamic result) {
        if (!didPop) {
          if (widget.onSwitchView != null) {
            widget.onSwitchView!('distribusi');
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            StatistikAppBar(
              title: 'Skema Pemegang Sertifikat',
              currentView: 'sertifikat',
              onBack: () {
                if (widget.onSwitchView != null) {
                  widget.onSwitchView!('distribusi');
                } else if (widget.onBackToHome != null) {
