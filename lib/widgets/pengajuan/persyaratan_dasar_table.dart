...
class _PersyaratanDasarTableState extends State<PersyaratanDasarTable> {
  final List<String> _items = [
    ...
    'Foto copy sertifikat pelatiha berbasis kompetensi di bidang digital marketing',
    'Surat keterangan pengalaman kerja minimal 1 tahun secara berkelanjutan dibidang marketing',
  ];
